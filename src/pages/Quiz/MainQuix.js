                ...
                <IonPage>
                    <div>
                        ...
                        <div className="result">
                            ...
                            <h3 className="result_subhead">Your Score: {this.state.score}/5 </h3>
                            <IonButton className="score_bn">Reward: 
                            </IonButton><p>Enchanting plant!</p><p>Take good care of it</p>
                        </div>
                        <img className="score_plant" src="https://cdn.pixabay.com/photo/2014/04/07/16/51/leaves-318743__480.jpg" alt="Your Score" />
